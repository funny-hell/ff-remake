...
const vec4  light_color = vec4(0.28, 0.255, 0.26, 0.8); // r, g, b, a. the gradient light that is above (and on top) of the water
const vec4  glow_color = vec4(0.28, 0.255, 0.26, 0.0);  // alpha is unused here. the color that white parts glow when near water
